...
import { AtSign, Lock, Eye, EyeOff, Loader2, MessageSquare } from "lucide-react";

// ✅ Validation schema
const schema = yup.object({
  identifier: yup.string().trim().required("Please enter your email or username"),
  password: yup
    .string()
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="text-zinc-300">Email or u.id</FormLabel>
                      <FormControl>
